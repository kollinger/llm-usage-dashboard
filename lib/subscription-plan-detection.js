...
function detectOpenAiPlanType(value, options = {}) {
  ...
  if (/\bteam\b|\bbusiness\b/.test(signals.key)) return "Team";
  if (/\bplus\b/.test(signals.key)) return "Plus";
...
function detectClaudePlanType(value, options = {}) {
  ...
  if (/\bteam\b|\bbusiness\b/.test(signals.key)) return /\bclaude team\b/.test(signals.key) ? "Claude Team" : "Team";
  if (/\bpro\b/.test(signals.key)) return /\bclaude pro\b/.test(signals.key) ? "Claude Pro" : "Pro";
